comparar_nt_frecuencias <- function(frecuencias, nota_tecnica, agrupador) {
  ...
  frec_y_nt <- frecuencias %>%
    ...
    group_by(agrupador, frec_mes, cm, valor_mes, frec_suma, frec_media,
      frec_suma_por_cm, frec_media_por_cm) %>%
    relocate(agrupador, frec_mes, cm, valor_mes, frec_suma, frec_media,
      frec_suma_por_cm, frec_media_por_cm)
